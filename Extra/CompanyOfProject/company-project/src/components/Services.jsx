...
export default function Services() {
    return (
        <div>
            <div class="flex flex-col bg-servicesImage bg-cover h-56 w-full bg-no-repeat mt-8  text-white justify-center align-middle	">
                <span class="text-center font-custom1 text-6xl	tracking-wide">Hizmetler</span>
            </div>
