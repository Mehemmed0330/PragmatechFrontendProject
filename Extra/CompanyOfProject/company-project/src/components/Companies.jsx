...
export default function Companies() {
    return (
        <div>
            <div class="px-4 pb-5 flex  flex-wrap justify-center	">
                <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-2">
                    <div>
                        <img src={CompanyFirst} class="rounded-t-lg" alt="" />
                    </div>
                    <div class="p-5">
                        <div>
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Alkollü Araç Kullanımı</h5>
                        </div>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Kaza riskleri nedeniyle trafik polisi için, sürücülerin alkol kontrolünün özel bir önemi vardır. Sürücü, alkolmetre ile yapılan test sonucunda alkollü çıkarsa; 2918 Sayılı Karayolları Trafik Kanunu'nun 48/5 maddesi gereğince para cezası ile cezalandırılır, aracı trafikten men edilir ve sürücü belgesi (6) ay süreyle Trafik Polisince geri alınır.
                ...
                <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-2">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">İlk kez alkollü araç kullanan kişi 1823 TL,
                ...
                </div> <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-2">
                    <div>
                        <img src={CompanyFirst} class="rounded-t-lg" alt="" />
                    </div>
                    <div class="p-5">
                        <div>
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Emniyet Şeridi Cezası 2022 Ücretleri</h5>
                        </div>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Trafik ekiplerinin denetimleri sonucunda emniyet şeridi ihlali yapan sürücülere ceza kesme işlemi uygulanıyor. Aynı zamanda elektronik denetleme sistemleri ile şerit ihlallerini plaka üzerinden takip ederek trafik cezasına dönüştürülüyor. Emniyet şeridini uygunsuz kullanma cezası 2022 itibarıyla 1.823 TL tutarında. Ceza kesildikten itibaren 15 gün içinde ödeme yaparsanız indirimli ödüyorsunuz. Böylece diğer cezalardaki gibi %25 indirimli ödeyebilirsiniz.
